...
function getBookFromNumber(bookNumber: any, bookAudio = true) {
  ...
  return bookAudio
    ? youtubeData.bookAudioPlaylists.find((b) =>
        b.playlistTitle.includes("Book " + bookNumber + " -")
      ) ??
        youtubeData.bookAudioPlaylists.find((b) =>
          b.playlistTitle.includes("2nd Edition")
        )!
    : youtubeData.supplementVocabPlaylists.find((b) =>
        b.playlistTitle.includes("Book " + bookNumber + " -")
      ) ??
        youtubeData.supplementVocabPlaylists.find((b) =>
          b.playlistTitle.includes("2nd Edition")
